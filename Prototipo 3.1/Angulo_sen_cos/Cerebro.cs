...
namespace ProjetilTeste
{
    ...
    public static class Cerebro
    {
        ...
        private static Meteoro meteoro = new Meteoro(100, 4000, 5000);
        

        //Cria objeto Projetil com velocidade inicial, angulo e presição
        private static Projetil projetil = new Projetil(400, 35);
        ...
        public static void MudarPosicaoMeteoro(double X, Double Y)
        {
            meteoro.posicaoX0 = X;
            meteoro.posicaoY0 = Y;
        }
        ...
        public static List<string> TesteBtnAngulo()
        {
            ...
            {
                listaValoresValido.Add("Angulo não é suficiente, tente ourto");
            }
        ...
        public static List<string> TesteBtnVelocidade()
        {
            //Cria uma lista de valores ideais de angulos
            List<string> listaValoresValido = new List<string> { };
            ...
            //Loop que testa velocidade de 0 a 1000 m/s de 10 em 10
            for (int ang = 1; ang <= 90; ang += 1)
            {
                //Verifica se vai alcançar pelo menos a posição x do meteoro
                if (FormulasFisica.AlcanceHorizontal(VelocidadeInicial, ang, pres) > meteoro.posicaoX0)
                {
                    ...
                    do
                    {
                        ...
                        projetil.AnguloLancamento = ang;
                        projetil.vX = FormulasFisica.VX0(VelocidadeInicial, ang);
                        projetil.MovX(tempo);
                        projetil.MovY();
                        ...
                        if (Contato())
                        {
                            ...
                            //Salva o valor da velocidade
                            listaValoresValido.Add(Convert.ToString(ang));
            ...
            if (listaValoresValido.Count() == 0)
            {
                listaValoresValido.Add("Velocidade não é suficiente, tente ourto");
            }
