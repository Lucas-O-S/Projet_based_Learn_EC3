...
namespace ProjetilTeste
{
    public static class FormulasFisica
    {
        ...
        public static double VX0(double V0, int angulo)
        {
            Double vx0 = V0 * Angulo.Cos(angulo, Encontro.pres);
        ...
        public static double MovYSubindo(double SY0, double tempo, double VY0)
        {
        ...
        public static double MovYDescendo(double SY0, double tempo, double VY0)
        {
            double posicaoY = SY0 + -VY0 * tempo - (G / 2) * Math.Pow(tempo, 2);
            return posicaoY;
        ...
        public static double EquTrajetoria(int angulo,double SX, double V0)
        {
            double SY = Angulo.Tan(angulo,Encontro.pres) * SX - (G / (2 * Math.Pow(V0, 2) * Math.Pow(Angulo.Cos(angulo,Encontro.pres), 2))) * Math.Pow(SX,2) ;
            return SY;
            /*
            SY = Trajetoria
            Angulo = Angulo
