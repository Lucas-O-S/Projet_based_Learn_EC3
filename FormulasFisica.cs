...
namespace Angulo_sen_cos
{
    public static class FormulasFisica
    {
        ...
        public static double MovX(double SX0, int tempo, double VX0)
        {
        ...
        public static double MovY(double SY0, int tempo, double VY0)
        {
        ...
        public static double VelocY(double SY0, int tempo, double VY0)
        {
